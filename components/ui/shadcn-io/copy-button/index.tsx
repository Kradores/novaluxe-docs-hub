...
import { CheckIcon, CopyIcon, LucideProps } from 'lucide-react';
...
type CopyButtonProps = Omit<HTMLMotionProps<'button'>, 'children' | 'onCopy'> &
  VariantProps<typeof buttonVariants> & {
    ...
    CustomCopyIcon?: React.ForwardRefExoticComponent<Omit<LucideProps, "ref"> & React.RefAttributes<SVGSVGElement>>
  };
...
function CopyButton({
  ...
  const SelectedCopyIcon = CustomCopyIcon ?? CopyIcon;
  const Icon = localIsCopied ? CheckIcon : SelectedCopyIcon;
