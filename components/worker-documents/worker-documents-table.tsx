...
import { WorkerDocumentModel } from "@/types/worker";

import DeleteConfirmButton from "./delete-confirm-button";
import DownloadButton from "./download-button";

type WorkerDocumentsTableProps = {
  documents: WorkerDocumentModel[];
};

export default function WorkerDocumentsTable({
  documents,
}: WorkerDocumentsTableProps) {
  const t = useTranslations("workerDocuments.table");
